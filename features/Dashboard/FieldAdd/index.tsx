...
import useDashboardFieldAddFeature from "./hook";

const DashboardFieldAddFeature = () => {
  const {
    form,
    data,
    isLoading,
    ...
    setIsImageUpload,
    handleImageUpload,
  } = useDashboardFieldAddFeature();

  return (
    <div className="relative">
      <h1 className="font-bold text-3xl mb-3">Add New Fields</h1>
          ...
          >
            <div className="grid gap-4">
                    ...
                    >
                      ...
                      <SelectContent>
                        {isLoading ? (
                          ...
                          data?.data.map((location: ILocationSchema) => (
                            <SelectItem
                              key={location.id}
                              value={location.id || ""}
                            >
              ...
              <Button
                type="submit"
                className="w-full"
                disabled={isPending || isImageUpload}
              >
...
export default DashboardFieldAddFeature;
